...
final class DanmakuViewModel: ObservableObject {
    ...
    @Published private(set) var active: [ActiveDanmaku] = []
    ...
    init(service: DanmakuService = .shared) {
    ...
    func update(time: Double, size: CGSize, settings: RenderSettings) {
    ...
    func xPosition(for activeItem: ActiveDanmaku, time: Double, width: CGFloat) -> CGFloat {
