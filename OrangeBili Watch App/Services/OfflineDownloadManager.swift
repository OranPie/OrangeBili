...
struct DownloadStatusItem: Identifiable, Hashable {
    ...
    init(bvid: String, title: String, coverURL: URL?) {
        id = UUID()
        self.bvid = bvid
        self.title = title
...
final class OfflineDownloadManager: NSObject, ObservableObject {
    ...
    @Published private(set) var items: [DownloadStatusItem] = []
    ...
    func startDownload(bvid: String, title: String, url: URL, headers: [String: String], coverURL: URL?) {
