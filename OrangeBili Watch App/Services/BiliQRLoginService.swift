...
struct BiliQRLoginService {
    func generate() async throws -> QRLoginGenerateResult {
    ...
    func poll(qrcodeKey: String) async throws -> QRLoginPollResult {
